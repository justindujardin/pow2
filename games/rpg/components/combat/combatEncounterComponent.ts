...
module rpg.components.combat {
  ...
  export class CombatEncounterComponent extends pow2.scene.SceneComponent {
    ...
    player:rpg.objects.GameEntityObject = null;
    ...
    syncComponent():boolean {
      ...
      if (this.host.scene) {
        this.player = <rpg.objects.GameEntityObject>this.host.scene.objectByComponent(pow2.scene.components.PlayerComponent);
      }
      this.listenMoves();
      return !!this.player;
    }
