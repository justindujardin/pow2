...
declare module pow2 {
     ...
     */
    interface ISceneObject extends IObject, IProcessObject, IComponentHost {
        scene: IScene;
        enabled: boolean;
        point: Point;
        size: Point;
    ...
    interface IScene extends IEvents {
        ...
        componentByType(type: any): IComponent;
        componentsByType(type: any): IComponent[];
...
declare module pow2.scene {
     ...
     */
    class SceneObject extends pow2.Entity {
        id: string;
        _uid: string;
        name: string;
        scene: Scene;
...
declare module pow2.scene {
     ...
     */
    class SceneComponent extends pow2.Component {
        host: SceneObject;
    }
}
declare module pow2.scene {
