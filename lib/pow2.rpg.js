...
(function (rpg) {
    ...
    (function (components) {
        ...
        (function (_combat) {
            ...
            _combat.CombatActionComponent = CombatActionComponent;
...
(function (rpg) {
    ...
    (function (_components) {
        ...
        })(combat = _components.combat || (_components.combat = {}));
    })(components = rpg.components || (rpg.components = {}));
})(rpg || (rpg = {}));
/*
 Copyright (C) 2013-2015 by Justin DuJardin and Contributors
    ...
    (function (services) {
        var PowGameService = (function () {
            function PowGameService(compile, scope) {
                ...
                this.entities = this.world.loader.load('games/rpg/entities/map.powEntities');
            }
    ...
    (function (directives) {
        var CombatViewController = (function () {
            ...
            CombatViewController.prototype.getSpells = function () {
                ...
                var spells = this.game.world.spreadsheet.getSheetData('magic');
                var host = this.choosingSpell.host;
                var userLevel = host.model.get('level');
                var userClass = host.model.get('type');
                var results = _.filter(spells, function (spell) {
    ...
    (function (states) {
        ...
        var GameCombatState = (function (_super) {
            ...
            function GameCombatState() {
                ...
                rpg.GameWorld.get().loader.load('games/rpg/entities/combat.powEntities', function (factory) {
