        ...
        var PlayerComponent = (function (_super) {
            ...
            PlayerComponent.prototype.collideMove = function (x, y, results) {
                ...
                if (this.map && this.paths && this.map.bounds.pointInRect(x, y)) {
                    return this.paths._graph.input[x][y] >= 1000 /* BLOCKED */;
                }
                return false;
            };
        ...
        var DorkaponCombatInit = (function (_super) {
            ...
            DorkaponCombatInit.prototype.enter = function (machine) {
                ...
                if (machine.left.model instanceof dorkapon.models.DorkaponPlayer) {
                    ...
                    render.setHeading(1 /* EAST */, false);
                }
                    ...
                    render.setHeading(0 /* WEST */, false);
                }
        ...
        var DorkaponCombatExecuteMoves = (function (_super) {
            ...
            DorkaponCombatExecuteMoves.prototype.enter = function (machine) {
                ...
                if (player) {
                    ...
                    player.attackDirection = west ? 0 /* WEST */ : 1 /* EAST */;
                    player.attack(function () {
                        ...
                        switch (machine.defenderMove) {
                            case 5 /* DEFEND */:
                                if (machine.attackerMove === 1 /* ATTACK */ || machine.attackerMove === 4 /* STRIKE */) {
                                    attackDamage -= machine.defender.model.getDefense();
                                }
                                break;
                            case 6 /* DEFEND_MAGIC */:
                                if (machine.attackerMove === 2 /* ATTACK_MAGIC */) {
                            ...
                            case 7 /* DEFEND_SKILL */:
                                break;
                            case 8 /* COUNTER */:
                                if (machine.attackerMove === 4 /* STRIKE */) {
...
(function (dorkapon) {
    var DorkaponGameWorld = (function (_super) {
        ...
        function DorkaponGameWorld(services) {
            ...
            this.factory = this.loader.load(dorkapon.ENTITIES_CONTAINER);
        }
        /**
    ...
    (function (controllers) {
        var CombatChooseMoveController = (function () {
            ...
            CombatChooseMoveController.prototype.select = function (type) {
                switch (type) {
                    case 'physical':
                        this.$mdDialog.hide(this.attack ? 1 /* ATTACK */ : 5 /* DEFEND */);
                        break;
                    case 'magic':
                        this.$mdDialog.hide(this.attack ? 2 /* ATTACK_MAGIC */ : 6 /* DEFEND_MAGIC */);
                        break;
                    case 'special':
                        this.$mdDialog.hide(this.attack ? 4 /* STRIKE */ : 8 /* COUNTER */);
                        break;
                    case 'skill':
                        this.$mdDialog.hide(this.attack ? 3 /* ATTACK_SKILL */ : 7 /* DEFEND_SKILL */);
                        break;
                }
            };
