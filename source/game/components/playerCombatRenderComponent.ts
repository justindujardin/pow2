...
module pow2.game.components {
  ...
  export class PlayerCombatRenderComponent extends pow2.scene.components.TickedComponent {
    ...
    attackDirection:pow2.game.components.Headings = pow2.game.components.Headings.WEST;
